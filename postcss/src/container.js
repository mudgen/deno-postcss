...
class Container extends Node {
  ...
  async normalize(nodes, sample) {
    if (typeof nodes === "string") {
      const parse = (await import("./parse.js")).default;
      ...
      const Rule = (await import("./rule.js")).default;
      nodes = [new Rule(nodes)];
    } else if (nodes.name) {
      const AtRule = (await import("./at-rule.js")).default;
